...
function YoutubeResources(){
  ...
  <link
    ...
    as="script"
    crossOrigin=""
    href="./ListingPageHome_files/entry.aba853e3.js.download"
  />
  <link
    rel="preload"
    as="style"
    href="./ListingPageHome_files/entry.e6c8eea1.css"
  />
  <link rel="stylesheet" href="./ListingPageHome_files/entry.e6c8eea1.css" />
  <div id="__nuxt">
    {/*[*/}
    <div>
      ...
      <div>
        ...
        <section className="pt-20 md:pt-24 relative">
          <div className="w-full px-5 sm:px-8 md:px-12 lg:px-8 max-w-screen-lg lg:max-w-screen-xl mx-auto">
            ...
            <div className="relative">
              <div className="insisible opacity-0 flex absolute top-1/2 -left-5 -translate-y-1/2 z-10 transition duration-300 ease-linear">
                <button className="outline-none p-3 rounded-full relative group text-gray-700 dark:text-gray-400 bg-body">
                  <span className="absolute inset-0 rounded-full group-hover:scale-105 origin-center transition-all ease-in-out border border-box-border" />
              ...
              <div className="flex absolute top-1/2 -right-5 -translate-y-1/2 z-10 transition duration-300 ease-linear visible opacity-100">
                <button className="outline-none p-3 rounded-full relative group text-gray-700 dark:text-gray-400 bg-body">
                  <span className="absolute inset-0 rounded-full group-hover:scale-105 origin-center transition-all ease-in-out border border-box-border" />
                  <span className="relative">
                    {/*[*/}
              ...
              <div className="md:py-2 lg:py-4 relative">
                <div className="absolute right-0 top-0 h-full w-full flex justify-end">
                  <span className="flex opacity-20">
                    <span className="w-16 h-32 rounded-l-full flex bg-primary blur-2xl" />
                    <span className="w-16 h-32 rounded-r-full flex bg-[#f88fc2] blur-2xl mt-14" />
                  </span>
                </div>
                <div className="relative">
                  <h2 className="text-2xl md:text-3xl text-gray-800 dark:text-white font-bold">
        ...
        <section className="pt-20 md:pt-24">
          <div className="w-full px-5 sm:px-8 md:px-12 lg:px-8 max-w-screen-lg lg:max-w-screen-xl mx-auto">
            ...
            <div className="grid md:grid-cols-2 gap-10 xl:gap-14 relative">
              <div className="md:py-2 lg:py-4 relative">
                <div className="absolute left-0 top-0 h-full w-full flex justify-end">
                  <span className="flex opacity-20">
                    <span className="w-16 h-32 rounded-l-full flex bg-primary blur-2xl" />
                    <span className="w-16 h-32 rounded-r-full flex bg-[#f88fc2] blur-2xl mt-14" />
                  </span>
        ...
        <section className="py-20">
          <div className="w-full px-5 sm:px-8 md:px-12 lg:px-8 max-w-screen-lg lg:max-w-screen-xl mx-auto">
            {/*[*/}
            <div className="w-full relative py-8 md:py-10 px-6 md:px-8 rounded-2xl bg-gradient-to-tr from-gray-100 to-gray-200 dark:from-gray-900 dark:to-body-color">
              <div className="absolute right-0 top-0 h-full w-full flex justify-end">
                <span className="flex opacity-20">
                  <span className="w-16 h-32 rounded-l-full flex bg-primary blur-2xl" />
                  <span className="w-16 h-32 rounded-r-full flex bg-[#f88fc2] blur-2xl mt-14" />
                ...
                <div className="mx-auto max-w-md sm:max-w-xl pt-10">
                  ...
                  >
                    <input
                      ...
                      className="outline-none border-2 border-transparent focus:border-primary bg-body text-gray-600 dark:text-gray-200 rounded-3xl px-6 py-3 w-full"
                    />
      ...
      <footer className="pt-20 bg-gray-100 dark:bg-body border-t border-gray-200 dark:border-gray-100/20">
        <div className="w-full px-5 sm:px-8 md:px-12 lg:px-8 max-w-screen-lg lg:max-w-screen-xl mx-auto pb-10">
          {/*[*/}
          <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-8 gap-y-10">
